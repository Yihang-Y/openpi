...
def make_aloha_example() -> dict:
    ...
    return {
        "state": np.ones((7,)),
        "images": {
            "image_1": np.random.randint(256, size=(3, 224, 224), dtype=np.uint8),
            "image_2": np.random.randint(256, size=(3, 224, 224), dtype=np.uint8),
            "image_3": np.random.randint(256, size=(3, 224, 224), dtype=np.uint8),
        },
        "prompt": "do something",
    }
...
class AlohaInputs(transforms.DataTransformFn):
    ...
    EXPECTED_CAMERAS: ClassVar[tuple[str, ...]] = ("image_1", "image_2", "image_3")
